...
public class AreaSize {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int areaDimensions = 100; areaDimensions <= 100; areaDimensions*=10) {
				...
				wLoad.add(new QWload(600, 600, numBatches * batchSize));
				allQueries = QWload.getInterleavedQLoad(wLoad, areaDimensions);
	...
	private static void init(JobConf conf, int numFiles, CostEstimator costEstimator) {
		...
		String statsFileName = "/home/aaly/expResults/areaSize.csv";		
		try {
